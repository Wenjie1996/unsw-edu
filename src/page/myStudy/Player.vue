  ...
  methods: {
    ...
    getData (text) {
      if (text == 'close') {
        ...
        this.playerOptions.sources[0].src = text
        setTimeout(() => {
          ...
          div3.innerText = this.userName
          div3.style.cssText = "position:absolute;top:100px;left:150px; color:#e6984d;font-size:25px;opacity:0.5;padding-top:10px";
